...
export default function JobDetailPage() {
  ...
  // Clean and decode the HTML description
  ...
  const jsonldData = generateJobPostingJsonLD({
    ...
    validThrough: new Date(
      new Date(job.publication_date).getTime() + 1000 * 60 * 60 * 24 * 30
    ...
    jobLocation: {
      address: {
        ...
        addressCountry: "DE", // Adjust based on actual location logic
      },
    },
  });
  ...
  return (
    <section className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="flex flex-wrap gap-2 text-sm mb-6">
        ...
        {job.salary && (
          <span className="bg-yellow-100 px-2 py-1 rounded">💸 {job.salary}</span>
        )}
      </div>
